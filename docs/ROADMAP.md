...
- [ ] PDF 생성 및 다운로드 (`/api/invoices/[id]/pdf`)
- [x] 견적서 링크 복사 기능
- [x] "초안" 상태 견적서 접근 차단
...
- PDF API 라우트가 501 플레이스홀더 상태 -> Task 007에서 구현 예정
- `generateMetadata`에서 견적서 번호 동적 반영 미구현 -> Task 009에서 구현 예정

...
- **인프라**: Vercel (vercel.json 설정 완료, 배포 준비)
...
- ~~`formatKRW`, `formatDate` 유틸 함수가 `invoice-list.tsx`와 `invoice-detail.tsx`에 중복 정의됨~~ -> Phase 4에서 `src/lib/format.ts`로 공통 추출 완료
...
| 2026-03-30 | 1.4.0 | Task 011~014 완료 표시 - Phase 4 편의 기능 완성, formatKRW/formatDate 기술 부채 해소, vercel.json 배포 설정 추가 | AI 아키텍트 |
